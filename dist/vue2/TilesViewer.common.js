...
const TILT_LIMIT = Math.cos( 70 * external_three_namespaceObject.MathUtils.DEG2RAD );

class OrbitControls extends external_three_namespaceObject.EventDispatcher {
	...
	constructor( object, domElement ) {
		...
		this.update = function () {
			...
			const offset = new external_three_namespaceObject.Vector3();

			// so camera.up is the orbit axis
			const quat = new external_three_namespaceObject.Quaternion().setFromUnitVectors( object.up, new external_three_namespaceObject.Vector3( 0, 1, 0 ) );
			const quatInverse = quat.clone().invert();

			const lastPosition = new external_three_namespaceObject.Vector3();
			const lastQuaternion = new external_three_namespaceObject.Quaternion();
			const lastTargetPosition = new external_three_namespaceObject.Vector3();
			...
			return function update( deltaTime = null ) {
				...
				if ( scope.zoomToCursor && performCursorZoom ) {
					...
					if ( scope.object.isPerspectiveCamera ) {
						...
						const mouseBefore = new external_three_namespaceObject.Vector3( mouse.x, mouse.y, 0 );
						...
						const mouseAfter = new external_three_namespaceObject.Vector3( mouse.x, mouse.y, 0 );
		...
		const spherical = new external_three_namespaceObject.Spherical();
		const sphericalDelta = new external_three_namespaceObject.Spherical();

		let scale = 1;
		const panOffset = new external_three_namespaceObject.Vector3();

		const rotateStart = new external_three_namespaceObject.Vector2();
		const rotateEnd = new external_three_namespaceObject.Vector2();
		const rotateDelta = new external_three_namespaceObject.Vector2();

		const panStart = new external_three_namespaceObject.Vector2();
		const panEnd = new external_three_namespaceObject.Vector2();
		const panDelta = new external_three_namespaceObject.Vector2();

		const dollyStart = new external_three_namespaceObject.Vector2();
		const dollyEnd = new external_three_namespaceObject.Vector2();
		const dollyDelta = new external_three_namespaceObject.Vector2();

		const dollyDirection = new external_three_namespaceObject.Vector3();
		const mouse = new external_three_namespaceObject.Vector2();
		...
		const panLeft = function () {
			...
			const v = new external_three_namespaceObject.Vector3();
...
class GLTFLoader extends external_three_namespaceObject.Loader {
	...
	load( url, onLoad, onProgress, onError ) {
		...
		if ( this.resourcePath !== '' ) {
			...
			const relativeUrl = external_three_namespaceObject.LoaderUtils.extractUrlBase( url );
			resourcePath = external_three_namespaceObject.LoaderUtils.resolveURL( relativeUrl, this.path );
	...
	decodePrimitive( primitive, parser ) {
		...
		return parser.getDependency( 'bufferView', bufferViewIndex ).then( function ( bufferView ) {
			...
			return new Promise( function ( resolve, reject ) {
				...
				}, threeAttributeMap, attributeTypeMap, external_three_namespaceObject.LinearSRGBColorSpace, reject );
...
const MemoryUtils_DdeKsIT5_b = /* @__PURE__ */ new external_three_namespaceObject.Spherical(), st = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Rt = {};
function ft(c) {
  const { x: t, y: i, z: e } = c;
  c.x = e, c.y = t, c.z = i;
}
...
function vt(c, t, i = !1) {
  const e = At(c, t, Rt);
  let o, s;
  return i ? (o = `${(external_three_namespaceObject.MathUtils.RAD2DEG * e.lat).toFixed(4)}°`, s = `${(external_three_namespaceObject.MathUtils.RAD2DEG * e.lon).toFixed(4)}°`) : (o = nt(external_three_namespaceObject.MathUtils.RAD2DEG * e.lat, "N", "S"), s = nt(external_three_namespaceObject.MathUtils.RAD2DEG * e.lon, "E", "W")), `${o} ${s}`;
}
const jt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  swapToThreeFrame: bt,
  toLatLonString: vt
}, Symbol.toStringTag, { value: "Module" })), rt = /* @__PURE__ */ new external_three_namespaceObject.Spherical(), MemoryUtils_DdeKsIT5_z = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), d = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_V = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_P = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), MemoryUtils_DdeKsIT5_S = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), at = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), MemoryUtils_DdeKsIT5_W = /* @__PURE__ */ new external_three_namespaceObject.Sphere(), MemoryUtils_DdeKsIT5_x = /* @__PURE__ */ new external_three_namespaceObject.Euler(), lt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), ct = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), ht = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_ = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_O = /* @__PURE__ */ new external_three_namespaceObject.Ray(), Nt = 1e-12, Bt = 0.1, MemoryUtils_DdeKsIT5_q = 0, pt = 1, MemoryUtils_DdeKsIT5_U = 2;
class Pt {
  constructor(t = 1, i = 1, e = 1) {
    this.name = "", this.radius = new external_three_namespaceObject.Vector3(t, i, e);
  }
  /**
  ...
  calculateEffectiveRadius(t) {
    const i = this.radius.x, o = 1 - this.radius.z ** 2 / i ** 2, s = t * external_three_namespaceObject.MathUtils.DEG2RAD, n = Math.sin(s) ** 2;
...
Dt.name = "WGS84 Earth";
const MemoryUtils_DdeKsIT5_L = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_j = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_f = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_G = /* @__PURE__ */ new external_three_namespaceObject.Ray();
class Gt {
  constructor(t = new external_three_namespaceObject.Box3(), i = new external_three_namespaceObject.Matrix4()) {
    this.box = t.clone(), this.transform = i.clone(), this.inverseTransform = new external_three_namespaceObject.Matrix4(), this.points = new Array(8).fill().map(() => new external_three_namespaceObject.Vector3()), this.planes = new Array(6).fill().map(() => new external_three_namespaceObject.Plane());
  }
  copy(t) {
...
const MemoryUtils_DdeKsIT5_Z = 1e-13, I = Math.PI, MemoryUtils_DdeKsIT5_H = I / 2, MemoryUtils_DdeKsIT5_B = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_C = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_T = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), a = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), MemoryUtils_DdeKsIT5_y = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), It = /* @__PURE__ */ new external_three_namespaceObject.Box3(), ut = /* @__PURE__ */ new external_three_namespaceObject.Matrix4();
function F(c, t) {
...
function dt(c, t, i, e) {
  try {
    return external_three_namespaceObject.TextureUtils.getByteLength(c, t, i, e);
  } catch {
...
class Ee extends Ue {
  constructor(t = external_three_namespaceObject.DefaultLoadingManager) {
    super(), this.manager = t, this.adjustmentTransform = new external_three_namespaceObject.Matrix4();
  }
  /**
...
const CameraTransitionManager_53n8z_Xc_bt = /* @__PURE__ */ new external_three_namespaceObject.Vector2();
function di(f, t, e = new external_three_namespaceObject.Vector3()) {
  ...
  const i = external_three_namespaceObject.MathUtils.clamp(-e.z, 0, 1);
...
class CameraTransitionManager_53n8z_Xc_Re extends index_core_G {
  ...
  parse(t) {
    return super.parse(t).then(async (e) => {
      const { featureTable: i, batchTable: s } = e, o = new external_three_namespaceObject.PointsMaterial(), n = i.header.extensions, r = new external_three_namespaceObject.Vector3();
      let a;
      if (n && n["3DTILES_draco_point_compression"]) {
        ...
        if (a = new external_three_namespaceObject.BufferGeometry(), P) {
          ...
          r.x = R[0], r.y = R[1], r.z = R[2], a.setAttribute("position", new external_three_namespaceObject.BufferAttribute(D, 3, !1));
        } else
          a.setAttribute("position", new external_three_namespaceObject.BufferAttribute(m, 3, !1));
        if (u !== null)
          a.setAttribute("normal", new external_three_namespaceObject.BufferAttribute(u, 3, !1));
        else if (l !== null) {
          const D = new Float32Array(h * 3), v = new external_three_namespaceObject.Vector3();
          for (let C = 0; C < h; C++) {
            const F = l[C * 2], ot = l[C * 2 + 1], A = di(F, ot, v);
            D[C * 3] = A.x, D[C * 3 + 1] = A.y, D[C * 3 + 2] = A.z;
          }
          a.setAttribute("normal", new external_three_namespaceObject.BufferAttribute(D, 3, !1));
        }
        if (x !== null)
          a.setAttribute("color", new external_three_namespaceObject.BufferAttribute(x, 4, !0)), o.vertexColors = !0, o.transparent = !0, o.depthWrite = !1;
        else if (d !== null)
          a.setAttribute("color", new external_three_namespaceObject.BufferAttribute(d, 3, !0)), o.vertexColors = !0;
        else if (O !== null) {
          ...
          const D = new external_three_namespaceObject.Color(M[0], M[1], M[2]);
          o.color = D;
          const v = M[3] / 255;
          v < 1 && (o.opacity = v, o.transparent = !0, o.depthWrite = !1);
        }
      }
      const c = new external_three_namespaceObject.Points(a, o);
...
const CameraTransitionManager_53n8z_Xc_Dt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_ht = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_pt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Ht = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Ct = /* @__PURE__ */ new external_three_namespaceObject.Quaternion(), St = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_dt = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_re = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_ae = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), ce = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_jt = /* @__PURE__ */ new external_three_namespaceObject.Quaternion(), CameraTransitionManager_53n8z_Xc_Gt = {};
function le(f, t, e, i) {
...
class Oe extends index_core_x {
  constructor(t = external_three_namespaceObject.DefaultLoadingManager) {
    super(), this.manager = t, this.adjustmentTransform = new external_three_namespaceObject.Matrix4(), this.ellipsoid = Dt.clone();
  }
    ...
    return super.parse(t).then((e) => {
      ...
      return new Promise((n, r) => {
        ...
        p.parse(o, h, (u) => {
          ...
          const A = new external_three_namespaceObject.Vector3();
          for (let b = 0; b < l; b++)
          ...
          u.scene.updateMatrixWorld(), u.scene.traverse((b) => {
            if (b.isMesh) {
              ie.push(b);
              const { geometry: lt, material: Bt } = b, Q = new external_three_namespaceObject.InstancedMesh(lt, Bt, l);
...
class ui extends index_core_M {
  ...
  parse(t) {
    ...
    return Promise.all(n).then((r) => {
      const a = new external_three_namespaceObject.Group();
      return r.forEach((c) => {
        a.add(c.scene);
      }), {
        tiles: r,
...
const _t = /* @__PURE__ */ new external_three_namespaceObject.Matrix4();
class mi extends external_three_namespaceObject.Group {
  constructor(t) {
    super(), this.isTilesGroup = !0, this.name = "TilesRenderer.TilesGroup", this.tilesRenderer = t, this.matrixWorldInverse = new external_three_namespaceObject.Matrix4();
  }
  raycast(t, e) {
...
const Ie = /* @__PURE__ */ new external_three_namespaceObject.Ray(), Zt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Et = [];
function ze(f, t) {
...
const CameraTransitionManager_53n8z_Xc_$ = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_Y = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_X = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), he = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_pe = /* @__PURE__ */ new external_three_namespaceObject.Vector3();
class gi {
  constructor() {
  ...
  setSphereData(t, e, i, s, o) {
    const n = new external_three_namespaceObject.Sphere();
...
const yi = /* @__PURE__ */ new external_three_namespaceObject.Matrix3();
function xi(f, t, e, i) {
  const s = yi.set(
    f.normal.x,
    f.normal.y,
...
class bi extends external_three_namespaceObject.Frustum {
  constructor() {
    super(), this.points = Array(8).fill().map(() => new external_three_namespaceObject.Vector3());
  }
...
const de = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), ue = /* @__PURE__ */ new external_three_namespaceObject.Euler(), CameraTransitionManager_53n8z_Xc_Ue = Symbol("INITIAL_FRUSTUM_CULLED"), CameraTransitionManager_53n8z_Xc_Rt = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_Mt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), qt = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), _i = /* @__PURE__ */ new external_three_namespaceObject.Vector3(1, 0, 0), Mi = /* @__PURE__ */ new external_three_namespaceObject.Vector3(0, 1, 0);
...
class Vi extends Re {
  ...
  constructor(...t) {
    super(...t), this.group = new mi(this), this.ellipsoid = Dt.clone(), this.cameras = [], this.cameraMap = /* @__PURE__ */ new Map(), this.cameraInfo = [], this._optimizeRaycast = !0, this._upRotationMatrix = new external_three_namespaceObject.Matrix4(), this._bytesUsed = /* @__PURE__ */ new WeakMap(), this._autoDisableRendererCulling = !0, this.manager = new external_three_namespaceObject.LoadingManager(), this._listeners = {};
  }
  addEventListener(t, e) {
    t === "load-tile-set" ? (console.warn('TilesRenderer: "load-tile-set" event has been deprecated. Use "load-tileset" instead.'), t = "load-tileset") : t === "load-content" && console.warn('TilesRenderer: "load-content" event has been deprecated. Use "load-model" or "load-tileset" instead.'), external_three_namespaceObject.EventDispatcher.prototype.addEventListener.call(this, t, e);
  }
  hasEventListener(t, e) {
    return t === "load-tile-set" ? (console.warn('TilesRenderer: "load-tile-set" event has been deprecated. Use "load-tileset" instead.'), t = "load-tileset") : t === "load-content" && console.warn('TilesRenderer: "load-content" event has been deprecated. Use "load-model" or "load-tileset" instead.'), external_three_namespaceObject.EventDispatcher.prototype.hasEventListener.call(this, t, e);
  }
  removeEventListener(t, e) {
    t === "load-tile-set" ? (console.warn('TilesRenderer: "load-tile-set" event has been deprecated. Use "load-tileset" instead.'), t = "load-tileset") : t === "load-content" && console.warn('TilesRenderer: "load-content" event has been deprecated. Use "load-model" or "load-tileset" instead.'), external_three_namespaceObject.EventDispatcher.prototype.removeEventListener.call(this, t, e);
  }
  dispatchEvent(t) {
    "tileset" in t && Object.defineProperty(t, "tileSet", {
      ...
      enumerable: !1,
      configurable: !0
    }), external_three_namespaceObject.EventDispatcher.prototype.dispatchEvent.call(this, t);
  }
  /* Public API */
  /**
  ...
  setCamera(t) {
    ...
    return i.has(t) ? !1 : (i.set(t, new external_three_namespaceObject.Vector2()), e.push(t), this.dispatchEvent({ type: "add-camera", camera: t }), !0);
  }
  /**
  ...
  prepareForTraversal() {
    ...
    for (; s.length < e.length; )
      s.push({
        ...
        position: new external_three_namespaceObject.Vector3(),
        invScale: -1,
        pixelSize: 0
  ...
  preprocessNode(t, e, i = null) {
    ...
    const s = new external_three_namespaceObject.Matrix4();
    if (t.transform) {
      const r = t.transform;
      for (let a = 0; a < 16; a++)
        s.elements[a] = r[a];
    ...
    const o = new external_three_namespaceObject.Matrix4().copy(s).invert(), n = new gi();
    ...
    switch (u) {
      ...
      case "glb": {
        ...
        !/[\\/]$/.test(R) && R.length && (R += "/"), p = g.parseAsync(t, R).then((D) => {
          D.scene = D.scene || new external_three_namespaceObject.Group();
          const { scene: v } = D;
...
class Pi extends external_three_namespaceObject.Mesh {
  constructor() {
    super(new external_three_namespaceObject.PlaneGeometry(0, 0), new wi()), this.renderOrder = 1 / 0;
  }
  onBeforeRender(t) {
...
class wi extends external_three_namespaceObject.ShaderMaterial {
  constructor() {
    super({
      depthWrite: !1,
      depthTest: !1,
      transparent: !0,
      uniforms: {
        resolution: { value: new external_three_namespaceObject.Vector2() },
        size: { value: 15 },
        thickness: { value: 2 },
        opacity: { value: 1 }
      },
...
const fe = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), CameraTransitionManager_53n8z_Xc_ge = /* @__PURE__ */ new external_three_namespaceObject.Vector2();
class Ti {
  constructor() {
    this.domElement = null, this.buttons = 0, this.pointerType = null, this.pointerOrder = [], this.previousPositions = {}, this.pointerPositions = {}, this.startPositions = {}, this.pointerSetThisFrame = {}, this.hoverPosition = new external_three_namespaceObject.Vector2(), this.hoverSet = !1;
  }
  reset() {
    this.buttons = 0, this.pointerType = null, this.pointerOrder = [], this.previousPositions = {}, this.pointerPositions = {}, this.startPositions = {}, this.pointerSetThisFrame = {}, this.hoverPosition = new external_three_namespaceObject.Vector2(), this.hoverSet = !1;
  }
  ...
  addPointer(t) {
    const e = t.pointerId, i = new external_three_namespaceObject.Vector2();
...
const CameraTransitionManager_53n8z_Xc_Ot = /* @__PURE__ */ new external_three_namespaceObject.Matrix4();
function xt(f, t, e) {
...
function CameraTransitionManager_53n8z_Xc_j(f, t, e) {
  const i = f instanceof external_three_namespaceObject.Ray ? f : f.ray, { origin: s, direction: o } = i;
  s.set(t.x, t.y, -1).unproject(e), o.set(t.x, t.y, 1).unproject(e).sub(s), f.isRay || (f.near = 0, f.far = o.length(), f.camera = e), o.normalize();
}
const CameraTransitionManager_53n8z_Xc_Z = 0, it = 1, CameraTransitionManager_53n8z_Xc_K = 2, gt = 3, Qt = 4, CameraTransitionManager_53n8z_Xc_q = 5, CameraTransitionManager_53n8z_Xc_$t = 0.05, Yt = 0.025, et = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_It = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_k = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_ = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), zt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Ft = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_L = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_H = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Xt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_At = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_G = /* @__PURE__ */ new external_three_namespaceObject.Quaternion(), CameraTransitionManager_53n8z_Xc_ye = /* @__PURE__ */ new external_three_namespaceObject.Plane(), CameraTransitionManager_53n8z_Xc_I = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Lt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Kt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), vi = /* @__PURE__ */ new external_three_namespaceObject.Quaternion(), CameraTransitionManager_53n8z_Xc_S = /* @__PURE__ */ new external_three_namespaceObject.Ray(), Wt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Ut = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), CameraTransitionManager_53n8z_Xc_V = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), xe = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), CameraTransitionManager_53n8z_Xc_Pt = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), Jt = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), CameraTransitionManager_53n8z_Xc_be = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), CameraTransitionManager_53n8z_Xc_te = { type: "change" }, _e = { type: "start" }, Me = { type: "end" };
class Di extends external_three_namespaceObject.EventDispatcher {
  /**
  ...
  constructor(t = null, e = null, i = null, s = null) {
    super(), this.isEnvironmentControls = !0, this.domElement = null, this.camera = null, this.scene = null, this.tilesRenderer = null, this._enabled = !0, this.cameraRadius = 5, this.rotationSpeed = 1, this.minAltitude = 0, this.maxAltitude = 0.45 * Math.PI, this.minDistance = 10, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.zoomSpeed = 1, this.adjustHeight = !0, this.enableDamping = !1, this.dampingFactor = 0.15, this.fallbackPlane = new external_three_namespaceObject.Plane(new external_three_namespaceObject.Vector3(0, 1, 0), 0), this.useFallbackPlane = !0, this.enableFlight = !1, this.flightSpeed = 10, this.flightSpeedMultiplier = 4, this.scaleZoomOrientationAtEdges = !1, this.autoAdjustCameraRotation = !0, this.state = CameraTransitionManager_53n8z_Xc_Z, this.pointerTracker = new Ti(), this.needsUpdate = !1, this.actionHeightOffset = 0, this.pivotPoint = new external_three_namespaceObject.Vector3(), this.zoomDirectionSet = !1, this.zoomPointSet = !1, this.zoomDirection = new external_three_namespaceObject.Vector3(), this.zoomPoint = new external_three_namespaceObject.Vector3(), this.zoomDelta = 0, this.rotationInertiaPivot = new external_three_namespaceObject.Vector3(), this.rotationInertia = new external_three_namespaceObject.Vector2(), this.dragInertia = new external_three_namespaceObject.Vector3(), this.inertiaTargetDistance = 1 / 0, this.inertiaStableFrames = 0, this.pivotMesh = new Pi(), this.pivotMesh.raycast = () => {
    }, this.pivotMesh.scale.setScalar(0.25), this.raycaster = new external_three_namespaceObject.Raycaster(), this.raycaster.firstHitOnly = !0, this.up = new external_three_namespaceObject.Vector3(0, 1, 0), this._lastTime = performance.now(), this._keysDown = /* @__PURE__ */ new Set(), this._detachCallback = null, this._upInitialized = !1, this._lastUsedState = CameraTransitionManager_53n8z_Xc_Z, this._zoomPointWasSet = !1, this._tilesOnChangeCallback = () => this.zoomPointSet = !1, i && this.attach(i), e && this.setCamera(e), t && this.setScene(t), s && this.setTilesRenderer(s);
  }
  _getDeltaTime() {
  ...
  _setFrame(t) {
    ...
    if (o && (n || this._updateZoomPoint())) {
      if (CameraTransitionManager_53n8z_Xc_G.setFromUnitVectors(e, t), r) {
        ...
        a = external_three_namespaceObject.MathUtils.mapLinear(a, 0, 0.5, 0, 1), a = Math.min(a, 1), i.isOrthographicCamera && (a *= 0.1), CameraTransitionManager_53n8z_Xc_G.slerp(vi, 1 - a);
      }
  ...
  _alignCameraUp(t, e = 1) {
    ...
    let a = external_three_namespaceObject.MathUtils.mapLinear(1 - Math.abs(CameraTransitionManager_53n8z_Xc_L.dot(t)), 0, 0.2, 0, 1);
    a = external_three_namespaceObject.MathUtils.clamp(a, 0, 1), e *= a, Xt.crossVectors(t, CameraTransitionManager_53n8z_Xc_L), Xt.lerp(CameraTransitionManager_53n8z_Xc_H, 1 - e).normalize(), CameraTransitionManager_53n8z_Xc_G.setFromUnitVectors(CameraTransitionManager_53n8z_Xc_H, Xt), i.quaternion.premultiply(CameraTransitionManager_53n8z_Xc_G);
    let c = null;
...
const Pe = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_ut = /* @__PURE__ */ new external_three_namespaceObject.Matrix4(), CameraTransitionManager_53n8z_Xc_N = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_w = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_J = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_B = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Ci = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_mt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), tt = /* @__PURE__ */ new external_three_namespaceObject.Quaternion(), CameraTransitionManager_53n8z_Xc_we = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_rt = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_E = /* @__PURE__ */ new external_three_namespaceObject.Ray(), CameraTransitionManager_53n8z_Xc_Te = /* @__PURE__ */ new Pt(), Vt = /* @__PURE__ */ new external_three_namespaceObject.Vector2(), ve = {}, Si = 2550;
class ki extends Di {
  get tilesGroup() {
  ...
  constructor(t = null, e = null, i = null, s = null) {
    super(t, e, i), this.isGlobeControls = !0, this._dragMode = 0, this._rotationMode = 0, this.maxZoom = 0.01, this.nearMargin = 0.25, this.farMargin = 0, this.useFallbackPlane = !1, this.autoAdjustCameraRotation = !1, this.globeInertia = new external_three_namespaceObject.Quaternion(), this.globeInertiaFactor = 0, this.ellipsoid = Dt.clone(), this.ellipsoidGroup = new external_three_namespaceObject.Group(), this._ellipsoidFrameInverse = new external_three_namespaceObject.Matrix4(), s !== null && this.setTilesRenderer(s);
  }
  setTilesRenderer(t) {
   ...
   */
  setEllipsoid(t, e) {
    this.ellipsoid = t || Dt.clone(), this.ellipsoidGroup = e || new external_three_namespaceObject.Group();
  }
  getPivotPoint(t) {
  ...
  adjustCamera(t) {
    ...
    if (t.isPerspectiveCamera) {
      const a = CameraTransitionManager_53n8z_Xc_w.setFromMatrixPosition(e).sub(t.position).length(), c = o * r, p = external_three_namespaceObject.MathUtils.clamp((a - r) / c, 0, 1), h = external_three_namespaceObject.MathUtils.lerp(1, 1e3, p);
  ...
  _updateFlight(t) {
    ...
    if (i) {
      ...
      if (o > s && (this.getVectorToCenter(CameraTransitionManager_53n8z_Xc_w).normalize(), e.position.addScaledVector(CameraTransitionManager_53n8z_Xc_w, o - s), e.updateMatrixWorld()), !this._isNearControls()) {
        const n = external_three_namespaceObject.MathUtils.clamp(
          external_three_namespaceObject.MathUtils.mapLinear(this.getDistanceToCenter(), this._getPerspectiveTransitionDistance(), s, 0, 1),
          0,
          1
        );
  ...
  _updateZoom() {
    ...
    const r = external_three_namespaceObject.MathUtils.clamp(external_three_namespaceObject.MathUtils.mapLinear(Math.abs(t), 0, 20, 0, 1), 0, 1);
    if (this._isNearControls() || t > 0) {
      if (this._updateZoomDirection(), t < 0 && (this.zoomPointSet || this._updateZoomPoint())) {
        ...
        const a = external_three_namespaceObject.MathUtils.clamp(external_three_namespaceObject.MathUtils.mapLinear(-CameraTransitionManager_53n8z_Xc_we.dot(CameraTransitionManager_53n8z_Xc_rt), 1, 0.95, 0, 1), 0, 1), c = 1 - CameraTransitionManager_53n8z_Xc_B.dot(CameraTransitionManager_53n8z_Xc_rt), p = s.isOrthographicCamera ? 0.05 : 1, h = external_three_namespaceObject.MathUtils.clamp(r * 3, 0, 1), m = Math.min(a * c * p * h, 0.1);
      ...
      const a = this._getPerspectiveTransitionDistance(), c = this._getMaxPerspectiveDistance(), p = external_three_namespaceObject.MathUtils.mapLinear(this.getDistanceToCenter(), a, c, 0, 1);
      this._tiltTowardsCenter(external_three_namespaceObject.MathUtils.lerp(0, 0.4, p * r)), this._alignCameraUpToNorth(external_three_namespaceObject.MathUtils.lerp(0, 0.2, p * r));
      ...
      const a = this._getOrthographicTransitionZoom(), c = this._getMinOrthographicZoom(), p = external_three_namespaceObject.MathUtils.mapLinear(s.zoom, a, c, 0, 1);
      this._tiltTowardsCenter(external_three_namespaceObject.MathUtils.lerp(0, 0.4, p * r)), this._alignCameraUpToNorth(external_three_namespaceObject.MathUtils.lerp(0, 0.2, p * r));
  ...
  _getPerspectiveTransitionDistance() {
    ...
    if (!t.isPerspectiveCamera)
      throw new Error();
    const e = this._getMaxWorldRadius(), i = 2 * Math.atan(Math.tan(external_three_namespaceObject.MathUtils.DEG2RAD * t.fov * 0.5) * t.aspect), s = e / Math.tan(external_three_namespaceObject.MathUtils.DEG2RAD * t.fov * 0.5), o = e / Math.tan(i * 0.5);
    return Math.max(s, o);
  }
...
const CameraTransitionManager_53n8z_Xc_U = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_at = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), CameraTransitionManager_53n8z_Xc_ct = /* @__PURE__ */ new external_three_namespaceObject.OrthographicCamera(), Ei = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Ri = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), Oi = /* @__PURE__ */ new external_three_namespaceObject.Vector3(), De = /* @__PURE__ */ new external_three_namespaceObject.Quaternion(), Ii = /* @__PURE__ */ new external_three_namespaceObject.Quaternion();
class Ni extends external_three_namespaceObject.EventDispatcher {
  /**
  ...
  constructor(t = new external_three_namespaceObject.PerspectiveCamera(), e = new external_three_namespaceObject.OrthographicCamera()) {
    super(), this.perspectiveCamera = t, this.orthographicCamera = e, this.transitionCamera = new external_three_namespaceObject.PerspectiveCamera(), this.orthographicPositionalZoom = !0, this.orthographicOffset = 50, this.fixedPoint = new external_three_namespaceObject.Vector3(), this.duration = 200, this.autoSync = !0, this.easeFunction = (i) => i, this._target = 0, this._alpha = 0, this._clock = new external_three_namespaceObject.Clock();
  }
  /**
  ...
  update(t = Math.min(this._clock.getDelta(), 64 / 1e3)) {
    ...
    if (this._alpha !== this._target) {
      ...
      this._alpha = external_three_namespaceObject.MathUtils.clamp(this._alpha + p, 0, 1), this.dispatchEvent({ type: "change", alpha: this.alpha });
    }
    const r = o;
    let a = null;
  ...
  syncCameras() {
    ...
    if (CameraTransitionManager_53n8z_Xc_U.set(0, 0, -1).transformDirection(t.matrixWorld).normalize(), t.isPerspectiveCamera) {
      ...
      const n = Math.abs(CameraTransitionManager_53n8z_Xc_at.subVectors(e.position, o).dot(CameraTransitionManager_53n8z_Xc_U)), r = 2 * Math.tan(external_three_namespaceObject.MathUtils.DEG2RAD * e.fov * 0.5) * n, a = i.top - i.bottom;
      i.zoom = a / r, i.updateProjectionMatrix();
    } else {
      const n = Math.abs(CameraTransitionManager_53n8z_Xc_at.subVectors(i.position, o).dot(CameraTransitionManager_53n8z_Xc_U)), a = (i.top - i.bottom) / i.zoom * 0.5 / Math.tan(external_three_namespaceObject.MathUtils.DEG2RAD * e.fov * 0.5);
  ...
  _updateTransitionCamera() {
    ...
    const n = Math.abs(CameraTransitionManager_53n8z_Xc_at.subVectors(t.position, s).dot(CameraTransitionManager_53n8z_Xc_U)), r = 2 * Math.tan(external_three_namespaceObject.MathUtils.DEG2RAD * t.fov * 0.5) * n, a = Ii.slerpQuaternions(t.quaternion, CameraTransitionManager_53n8z_Xc_ct.quaternion, o), c = external_three_namespaceObject.MathUtils.lerp(t.fov, 1, o), p = r * 0.5 / Math.tan(external_three_namespaceObject.MathUtils.DEG2RAD * c * 0.5), h = Oi.copy(CameraTransitionManager_53n8z_Xc_ct.position).sub(s).applyQuaternion(De.copy(CameraTransitionManager_53n8z_Xc_ct.quaternion).invert()), m = Ri.copy(t.position).sub(s).applyQuaternion(De.copy(t.quaternion).invert()), u = Ei.lerpVectors(m, h, o);
    u.z -= Math.abs(u.z) - p;
    const l = -(m.z - u.z), d = -(h.z - u.z), x = external_three_namespaceObject.MathUtils.lerp(l + t.near, d + CameraTransitionManager_53n8z_Xc_ct.near, o), O = external_three_namespaceObject.MathUtils.lerp(l + t.far, d + CameraTransitionManager_53n8z_Xc_ct.far, o), M = Math.max(O, 0) - Math.max(x, 0);
...
class TilesViewer {
  ...
  _initScene() {
    ...
    this.scene.background = new external_three_namespaceObject.Color(0x111122);
    this.scene.fog = new external_three_namespaceObject.FogExp2(0x111122, 0.0003);

    this.camera = new external_three_namespaceObject.PerspectiveCamera(
      45,
    ...
    this.renderer = new external_three_namespaceObject.WebGLRenderer({ antialias: true });
    ...
    const gridHelper = new external_three_namespaceObject.GridHelper(200, 20, 0x88aaff, 0x335588);
    gridHelper.position.y = -1;
    this.scene.add(gridHelper);

    const axesHelper = new external_three_namespaceObject.AxesHelper(50);
    this.scene.add(axesHelper);

    const originSphere = new external_three_namespaceObject.Mesh(
      new external_three_namespaceObject.SphereGeometry(0.5, 16, 16),
      new external_three_namespaceObject.MeshStandardMaterial({ color: 0xff3333, emissive: 0x330000 })
    );
    this.scene.add(originSphere);

    const ambientLight = new external_three_namespaceObject.AmbientLight(0xffffff, 0.65);
    this.scene.add(ambientLight);
    const hemiLight = new external_three_namespaceObject.HemisphereLight(0x8bb5ff, 0x3b2a1f, 0.9);
    this.scene.add(hemiLight);
    const mainLight = new external_three_namespaceObject.DirectionalLight(0xfff5e6, 1.4);
    mainLight.position.set(6, 12, 8);
    mainLight.castShadow = true;
    this.scene.add(mainLight);
    const backLight = new external_three_namespaceObject.DirectionalLight(0x88aaff, 0.6);
    backLight.position.set(-4, 5, -6);
    this.scene.add(backLight);
    const rightFill = new external_three_namespaceObject.DirectionalLight(0xffaa88, 0.5);
    rightFill.position.set(4, 3, 5);
    this.scene.add(rightFill);
    const fillPoint = new external_three_namespaceObject.PointLight(0xffaa66, 0.35);
    fillPoint.position.set(2, 3, 2);
    this.scene.add(fillPoint);
    const leftFill = new external_three_namespaceObject.DirectionalLight(0xaaccff, 0.4);
  ...
  _prepareMeshMaterial(mesh) {
    ...
    materials.forEach((material) => {
      material.side = external_three_namespaceObject.DoubleSide;
  ...
  _handleClick(event) {
    ...
    const raycaster = new external_three_namespaceObject.Raycaster();
  ...
  _fitCamera() {
    ...
    if (sphere && sphere.radius > 0 && !isNaN(sphere.center.x)) {
      ...
      const verticalFov = external_three_namespaceObject.MathUtils.degToRad(this.camera.fov);
      const horizontalFov = 2 * Math.atan(Math.tan(verticalFov / 2) * this.camera.aspect);
      const fitFov = Math.min(verticalFov, horizontalFov);
      const distance = (sphere.radius / Math.sin(fitFov / 2)) * fitOffset;
      const direction = new external_three_namespaceObject.Vector3(1, 0.3, 1).normalize();
...
/******/ })()
;
//# sourceMappingURL=TilesViewer.common.js.map